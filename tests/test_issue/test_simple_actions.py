...
class TestIssueComment:
    ...
    def test_comment(self, cmd):
        result = cmd.run(argparse.Namespace(issue="TEST-1", comment="hello"))
...
class TestIssueLabel:
    ...
    def test_label(self, cmd):
        result = cmd.run(argparse.Namespace(issue="TEST-1", labels="bug,urgent"))
    ...
    def test_label_rejects_invalid(self, cmd):
        ...
        result = cmd.run(argparse.Namespace(issue="TEST-1", labels=" , "))
    ...
    def test_label_update_error(self, cmd):
        ...
        result = cmd.run(argparse.Namespace(issue="TEST-1", labels="bug"))
